...
| [`pinn/README.md`](Full_PINN_Code_figures_final_.ipynb) | The detailed, chronological, commit-by-commit research log — every round's exact commands, code changes, and metrics. |
